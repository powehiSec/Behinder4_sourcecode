...
public class HostDao extends BaseDao {
   public List<Host> findHostByShellId(int shellId) throws Exception {
   ...
   public List<Host> searchHostByShellIdAndIpOrComment(int shellId, String keyword) throws Exception {
      List<Host> result = new ArrayList();
