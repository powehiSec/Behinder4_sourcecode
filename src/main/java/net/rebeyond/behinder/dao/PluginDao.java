...
public class PluginDao extends BaseDao {
   public List<Plugin> findPluginByType(int type) throws Exception {
   ...
   public List<Plugin> findPluginByScriptType(String scriptType) throws Exception {
      List<Plugin> result = new ArrayList();
   ...
   public List<Plugin> findAllPlugins() throws Exception {
      List<Plugin> result = new ArrayList();
   ...
   public List<Plugin> findPluginByOs(int os) throws Exception {
      List<Plugin> result = new ArrayList();
   ...
   public List<Plugin> findPluginByLanguageAndOs(int language, int os) throws Exception {
      List<Plugin> result = new ArrayList();
