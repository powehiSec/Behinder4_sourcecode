...
public class ShellDao extends BaseDao {
   public List<Shell> findShellByTransProtocolName(String transProtocolName) throws Exception {
   ...
   public List<Shell> findShellByTransProtocolNameAndType(String transProtocolName, String type) throws Exception {
      List<Shell> result = new ArrayList();
