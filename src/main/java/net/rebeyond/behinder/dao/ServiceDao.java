...
public class ServiceDao extends BaseDao {
   public List<Service> findServiceByHostId(int hostId) throws Exception {
   ...
   public List<Service> findServiceByShellId(int shellId) throws Exception {
      List<Service> result = new ArrayList();
   ...
   public List<Service> searchServiceByShellIdAndNameOrPort(int shellId, String keyword) throws Exception {
      List<Service> result = new ArrayList();
