...
public class ParseProbes {
   ...
   public static void main(String[] args) throws Throwable {
      ...
      for(int var7 = 0; var7 < var6; ++var7) {
         ...
         Map<String, String> actionMap = getAction(line);
         ...
         if (action.equals("Probe")) {
            ...
            if (m.matches()) {
               ...
               service = m.group(2);
               regex = m.group(4);
               probeObj.put("type", (Object)type);
               probeObj.put("name", (Object)service);
               probeObj.put("challenge", (Object)regex);
            }

            probeObj.put("matches", (Object)matcheArr);
            probeArr.put((Object)probeObj);
         } else if (!action.equals("match") && !action.equals("softmatch")) {
            if (props.contains(action)) {
               String value = (String)actionMap.get("value");
               probeObj.put(action, (Object)value);
            ...
            if (m.matches()) {
               ...
               matchObj.put("service", (Object)service);
               matchObj.put("regex", (Object)regex);
               matchObj.put("option", (Object)option);
               System.out.println("option：" + option);
               matchObj.put("version", (Object)version);
               matchObj.put("version", (Object)parseVersion(version));
               matcheArr.put((Object)matchObj);
            }
         }
      }
   ...
   private static Map<String, String> getAction(String line) {
