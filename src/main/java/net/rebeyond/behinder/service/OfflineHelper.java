...
public class OfflineHelper {
   ...
   public void addRecord(String ip, Map<String, String> params, JSONObject result) {
      try {
   ...
   private void doAddRecord(String ip, String shellAction, Map<String, String> params, JSONObject result) throws Exception {
      JSONObject record = new JSONObject();
      record.put("shellId", this.shellId);
      record.put("target", (Object)ip);
      record.put("shellAction", (Object)shellAction);
      record.put("params", params);
      record.put("result", (Object)result);
      switch (shellAction) {
         case "runCmd":
         case "getBasicInfo":
         case "listFiles":
   ...
   public JSONObject getRecord(String shellAction, String target, Map<String, String> params) throws Exception {
   ...
   public JSONObject getCommonRecord(String shellAction, String target, Map<String, String> params) throws Exception {
      ...
      record.put("status", (Object)"failed");
      record.put("msg", (Object)"该记录未在离线模式中缓存。");
