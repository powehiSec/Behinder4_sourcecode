...
public class PluginService {
   ...
   public PluginService(IShellService shellService, JSONObject shellEntity, List<Thread> workList) {
      ...
      Runnable runner = () -> {
         try {
            ...
            if (type.equals("php")) {
               ...
               resultObj.put("status", (Object)"success");
               resultObj.put("msg", (Object)"ok");
            } else {
   ...
   public JSONObject getTaskResultSync(String pluginName) throws ExecutionException, InterruptedException {
      Callable<JSONObject> runner = () -> {
         ...
         try {
            ...
            msgObj.put("result", (Object)pluginResult);
            msgObj.put("running", (Object)pluginRunning);
            resultObj.put("msg", (Object)msgObj);
            return resultObj;
         } catch (Exception var7) {
            var7.printStackTrace();
            resultObj.put("status", (Object)"fail");
            resultObj.put("status", (Object)var7.getMessage());
            return resultObj;
         }
      };
