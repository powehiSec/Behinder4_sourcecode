...
public class LegacyCryptor implements ICrypt {
   ...
   private Map<String, TransProtocol> transProtocolMap = new HashMap();
   private String type;
   ...
   public LegacyCryptor(String type, int encryptType, String key) throws Exception {
      ...
      List<TransProtocol> transProtocolList = this.transProtocolDao.findTransProtocolsById(this.localTransProtocol.getId());
