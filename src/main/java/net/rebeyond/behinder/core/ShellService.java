...
public class ShellService implements IShellService {
   ...
   public ShellService(JSONObject shellEntity, List<Map<String, Object>> childList) throws Exception {
      ...
      while(var3.hasNext()) {
         Map<String, Object> childObj = (Map)var3.next();
   ...
   public String evalWithTransProtocol(String sourceCode) throws Exception {
      ...
      evalResult.put("msg", (Object)result);
      evalResult.put("status", (Object)"success");
   ...
   public JSONObject createBShell(String target) throws Exception {
      ...
      while(var8.hasNext()) {
         ...
         result.put(key, (Object)(new String(Base64.getDecoder().decode(result.getString(key)), "UTF-8")));
      }
   ...
   public JSONObject echo(String content) throws Exception {
      ...
      expectedSuccessObj.put("status", (Object)Base64.getEncoder().encodeToString("success".getBytes()));
      expectedSuccessObj.put("msg", (Object)Base64.getEncoder().encodeToString(content.getBytes()));
