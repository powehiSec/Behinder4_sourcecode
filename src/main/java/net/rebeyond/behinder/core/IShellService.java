...
public interface IShellService {
   void setProxy(Map<String, Object> var1);

   Map<String, Object> getProxy(Map<String, Object> var1);

   List<Map<String, Object>> getChildList();

   void setChildList(List<Map<String, Object>> var1);
   ...
   JSONObject submitPluginTask(String var1, String var2, Map<String, String> var3) throws Exception;

   JSONObject execPluginTask(String var1, String var2, Map<String, String> var3) throws Exception;
   ...
   Map<String, Object> transferPayload(byte[] var1) throws Exception;
