...
public class Plugin implements Runnable {
   ...
   public Plugin(Object payloadObj, Method payloadMethod, Map<String, Object> taskResult) {
   ...
   private String buildJsonArray(List<Map<String, Object>> list, boolean encode) throws Exception {
      StringBuilder sb = new StringBuilder();
      sb.append("[");
      Iterator var4 = list.iterator();

      while(var4.hasNext()) {
         Map<String, Object> entity = (Map)var4.next();
   ...
   private String buildTaskResult(Map<String, Object> taskResult, boolean encode) throws Exception {
