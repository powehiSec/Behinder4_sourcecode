   ...
   private void showTaskCenter() {
      ...
      while(var4.hasNext()) {
         ...
         if (!(task.getProgress() >= 1.0)) {
            ...
            progressPane.getChildren().addAll(taskProgress, taskPercent);
            ...
            taskItem.getChildren().addAll(taskName, progressPane, taskStatus);
            Separator separator = new Separator();
            taskContainer.getChildren().addAll(taskItem, taskDetail, separator);
