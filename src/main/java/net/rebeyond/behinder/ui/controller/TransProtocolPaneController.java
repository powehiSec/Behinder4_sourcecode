...
public class TransProtocolPaneController {
   ...
   private void initScriptTypeCombo() {
      this.scriptTypeCombo.setItems(FXCollections.observableArrayList("jsp", "php", "aspx", "asp"));
   ...
   private void initTransProtocolCombo() throws Exception {
      ...
      List<TransProtocol> transProtocolList = this.transProtocolDao.findTransProtocolByType(this.currentType);
