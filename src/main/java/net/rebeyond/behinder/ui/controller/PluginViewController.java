...
public class PluginViewController {
   ...
   public void init(IShellService shellService, PluginService pluginService, List<Thread> workList, List<Task> taskList, Label statusLabel, ShellManager shellManager, Map<String, String> basicInfoMap) {
   ...
   private void loadPlugins() throws Exception {
      ...
      List<Plugin> pluginList = this.pluginDao.findPluginByScriptType(scriptType);
